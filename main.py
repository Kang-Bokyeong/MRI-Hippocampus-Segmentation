...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_dir", default='D:/assignment/final/train_validation/img', type=str, help="The directory for training.")
    parser.add_argument("--eval_dir", default='D:/assignment/final/train_validation/img', type=str, help="The directory for evaluation.")
    parser.add_argument("--seg_dir", default='D:/assignment/final/train_validation/label', type=str, help="The directory for segmentation.")
